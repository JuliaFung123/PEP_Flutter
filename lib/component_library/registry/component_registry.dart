...
abstract final class ComponentRegistry {
  static final List<ComponentPageMeta> all = [
    ...
    _entry(ProgressIndicatorsComponentPage.meta, const ProgressIndicatorsComponentPage()),
  ...
  static List<ComponentLibrarySection> get sections {
    final themePages = all
        ...
        .toList();
    final atomPages = all
        .where((page) => page.group == ComponentLibraryGroup.atom)
        .toList()
  ...
  static ComponentPageMeta _entry(
    ComponentPageMetaData meta,
    Widget page,
  ) {
